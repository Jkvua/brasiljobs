  ...
  <div>
    ...
    <nav>
      ...
      >
        ...
        <v-toolbar-title
          >Brasil Jobs <v-spacer></v-spacer>
          <v-divider></v-divider>
          <v-divider vertical></v-divider>
          <v-btn text>
            <v-list-item
              v-for="item of elemento"
              :key="item.title"
              link
              :to="item.to"
            >
      ...
      <v-row>
        <v-col cols="6" sm="4">
          <v-img
            src="https://i.pinimg.com/564x/d3/7c/b1/d37cb1efe702dd266c5f6f18a9cdb99e.jpg"
            gradient="to top right, rgba(100,115,201,.33), rgba(25,32,72,.7)"
          ></v-img>
        </v-col>
        <v-col cols="6" sm="4">
          <v-img
            src="https://i.pinimg.com/564x/40/13/36/401336799683542b766d35c7769eee33.jpg"
            gradient="to top right, rgba(100,115,201,.33), rgba(25,32,72,.7)"
          ></v-img>
        </v-col>
        <v-col cols="6" sm="4">
          <v-img
            src="https://i.pinimg.com/564x/8b/d2/2b/8bd22b30ca7a42215b758f7a664a9a6e.jpg"
            gradient="to top right, rgba(100,115,201,.33), rgba(25,32,72,.7)"
          ></v-img>
        </v-col>
      </v-row>
      ...
      <br />
      <v-img
        src="https://i.pinimg.com/originals/03/cf/a5/03cfa585ed6e2460456bf53de5dc49bc.gif"
      >
...
export default {
  data() {
    return {
      ...
      object: [{ title: "Login", to: "/login" }],

      coisa: [{ title: "Cadastro", to: "/cadastro" }],

      elemento: [{ title: "Profissionais", to: "/profissionais" }],
